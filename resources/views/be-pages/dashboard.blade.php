    ...
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                            ...
                            <ul class="dropdown-menu notif-box" aria-labelledby="navbarDropdown">
                                ...
                                <li>
                                    <div class="notif-center">
                                        ...
                                        <a href="#">
                                            <div class="notif-img">
                                                <img src="be-assets/img/profile2.jpg" alt="Img Profile">
                                            </div>
                                            <div class="notif-content">
                                                <span class="block">
                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false"> <img src="be-assets/img/profile.jpg" alt="user-img"
                                    width="36" class="img-circle"><span>Hizrian</span></span> </a>
                            <ul class="dropdown-menu dropdown-user">
                                <li>
                                    <div class="user-box">
                                        <div class="u-img"><img src="be-assets/img/profile.jpg" alt="user">
                                        </div>
                                        <div class="u-text">
                                            <h4>Hizrian</h4>
        ...
        <div class="sidebar">
            <div class="scrollbar-inner sidebar-wrapper">
                <div class="user">
                    <div class="photo">
                        <img src="be-assets/img/profile.jpg">
                    </div>
                    <div class="info">
                            ...
                            <div class="card card-stats card-success">
                                <div class="card-body ">
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center">
                                            <div class="numbers">
                                                <p class="card-category">Jumblah Maintenance</p>
                                                <h4 class="card-title">1</h4>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card card-stats card-danger">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-7 d-flex align-items-center">
                                            <div class="numbers">
                                                <p class="card-category">Jumblah Repair</p>
                                                <h4 class="card-title">1</h4>
                                            </div>
                                        </div>
                                    </div>
